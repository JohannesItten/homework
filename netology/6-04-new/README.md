# Docker. Часть 2. Сергеев Дмитрий
### Задание 1
...
По версии официальной документации: *"Docker Compose — это инструмент для определения
и запуска многоконтейнерных приложений.
Он является ключом к оптимизации и эффективности процесса разработки и развертывания".*

Никак не улучшил. Ведь в базе контейнеры это всего лишь изолированные процессы
с помощью неймспейсов, chroot, etc. Никакой магии тут нет.
...
![docker compose down](assets/docker-down.png)
...
![prometheus alert](assets/promalert.png)
...
Для проверки корректности docker-compose.yml и сопутствующих скриптов. Грубо говоря: проверка,
что все работает как и задумано вне зависимости от окружения.